...
function NextImage() {
    ...
    const nextButton = document.querySelector(".gallery__move-button_right");
    const prevButton = document.querySelector(".gallery__move-button_left");
    ...
    const nextImage = document.querySelector(".gallery__image-container_next");
    const prevImage = document.querySelector(".gallery__image-container_previous");
    ...
    setTimeout(() => {
        ...
        prevImage.innerHTML = `<img src="images/${galleryCurrentImage}.webp" class="gallery__image" alt="you've lost an image"></img>`;
        leftImage.innerHTML = `<img src="images/${galleryCurrentImage + 1}.webp" class="gallery__image" alt="you've lost an image"></img>`;
        rightImage.innerHTML = `<img src="images/${galleryCurrentImage + 2}.webp" class="gallery__image alt="you've lost an image""></img>`;
        nextImage.innerHTML = `<img src="images/${galleryCurrentImage + 3}.webp" class="gallery__image alt="you've lost an image""></img>`;
        ++galleryCurrentImage;
        if (galleryCurrentImage < (galleryImageCount - 1)) {
...
function PreviousImage() {
    ...
    setTimeout(() => {
        ...
        prevImage.innerHTML = `<img src="images/${galleryCurrentImage - 2}.webp" class="gallery__image" alt="you've lost an image"></img>`;
        leftImage.innerHTML = `<img src="images/${galleryCurrentImage - 1}.webp" class="gallery__image alt="you've lost an image""></img>`;
        rightImage.innerHTML = `<img src="images/${galleryCurrentImage}.webp" class="gallery__image" alt="you've lost an image"></img>`;
        nextImage.innerHTML = `<img src="images/${galleryCurrentImage + 1}.webp" class="gallery__image" alt="you've lost an image"></img>`;
        nextButton.classList.remove("gallery__move-button_inactive");
        nextButton.classList.add("gallery__move-button_active");
        --galleryCurrentImage;
        if (galleryCurrentImage > 1) {
